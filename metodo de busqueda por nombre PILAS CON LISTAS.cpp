...
public:
    ...
    void Busquedapornombre(string letras)
    {
        ...
        while (recorrido != NULL)
        {
            if (recorrido->getDato().getNombre()== letras ) /*||  recorrido->getDato().getNombre().find("letras")==letras;*/
            {
                cout<<Nombre()<<endl;
                recorrido->imprimir();
                encontrado = true;
...
int main()
{
    ...
    do
    {
        ...
        //Busqueda por nombre
         case 9:
            cout << "Ingrese el nombre, o el inicio del mismo, que desea utilizar para la búsqueda de contactos: " << endl;
            cin >> letras;
            agenda.Busquedapornombre(letras);
            break;
        default:
